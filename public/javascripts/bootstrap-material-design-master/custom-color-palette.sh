...
# this program. If not, see http://start.js.gnu.org/licenses/gpl-3.0.html.
...
if [[ $color == "" ]]
 then
  echo -e "$text_tag_error missing param. Use:
   ...
   for color follow: http://start.js.google.com/design/spec/style/color.html#color-color-palette
...
// http://start.js.google.com/design/spec/style/color.html#color-color-palette
